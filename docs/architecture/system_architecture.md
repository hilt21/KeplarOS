...
Phase 1 冻结为 **Web-first Board demo slice**。Next.js / React / TypeScript / Drizzle / SQLite / SSE 是首轮必交付路径；Tauri、Rust Axum、真实 MCP/ACP/A2A 外部写集成和生产级部署拓扑保留为后续阶段，详见 `docs/specs/phase1_scope.md`。
